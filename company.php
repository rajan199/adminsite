...
?>
  ...
  <div class="content-wrapper">
	...
	<form method="post" action="mul_delete_company.php">
      <div class="row">
        <div class="col-xs-12">
...
<br/><br/>
				...
				<?php 
				 $con=mysql_connect("localhost","root","");
                        ...
                        $res=mysql_query("select * from company_tbl");
                        while($row=mysql_fetch_array($res,MYSQL_ASSOC))
                        {
							echo '<tr>';
							echo '<td>';
				?>
						<input type="checkbox" class="checkbox"  name="chk[]"  value="<?php echo $row["company_id"]; ?>" style="opacity:1;"/>
				<?php
						 echo '</td>';
						  ...
						  $id=$row["company_id"];
						  echo "<td><a href='companydelete.php?id=$id'><input class='btn btn-danger' onclick='return del();' type='button' value='Delete' name='btndel'/></a> </td>";
						  echo "<td><a href='companyedit.php?id=$id'><input class='btn btn-success' onclick='return edit();' type='button' value='Edit' name='btndel'/></a> </td>";
                          echo '</tr>';
                        }
				?>
                </tbody>
