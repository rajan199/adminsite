...
<br/><br/>
				...
				<?php 
				 $con=mysql_connect("localhost","root","");
                        ...
                        $res=mysql_query("select ca.*,c.*,p.* from category_tbl as ca,company_tbl as c,product_tbl as p where p.category_id=ca.category_id and p.company_id=c.company_id order by product_id desc",$con);
                        while($row=mysql_fetch_array($res,MYSQL_ASSOC))
                        {
                          echo '<tr>';
						  ?>
						 <td> <input type="checkbox" class="checkbox"  name="chk[]"  value="<?php echo $row["product_id"]; ?>" style="opacity:1;"/></td>
						 <?php
						  echo '<td>'.$row["product_name"].'</td>';
						  echo '<td> <img src="'.$row["product_img"].'" style="height: 130px;width: 160px;"'.'</td>';
						  ...
						  echo '<td>'.$row["company_name"].'</td>';
						  	...
						  	$id=$row["product_id"];
						  echo "<td><a href='product_delete.php?id=$id'><input class='btn btn-danger' onclick='return del();' type='button' value='Delete' name='btndel'/></a> </td>";
						  echo "<td><a href='product_edit.php?id=$id'><input class='btn btn-success' onclick='return edit();' type='button' value='Edit' name='btndel'/></a> </td>";
