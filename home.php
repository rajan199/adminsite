            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  ...
                  <a href="manageadminprofile.php?id=<?php echo $eid;?>" class="btn btn-default btn-flat">Profile</a>
                </div>
...
?>            
            ...
            <a href="perday_ord.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
?>            
              ...
              <h3><?php echo $cnt2; ?><sup style="font-size: 20px"></sup></h3>
            ...
            <a href="tot_male.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
?>
            ...
            <a href="tot_fmale.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
...
?>            
              ...
              <p>Total Sales of Current Month </p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="salesreport.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
