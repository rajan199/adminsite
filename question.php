...
<?php
  ...
  <div class="content-wrapper">
	...
	<form method="post" action="mul_del_question.php">
      <div class="row">
        <div class="col-xs-12">
              ...
              <table id="example" class="table table-bordered table-striped">
				...
				<?php 
				 $con=mysql_connect("localhost","root","");
                        ...
                        $res=mysql_query("select * from question_tbl");
                        while($row=mysql_fetch_array($res,MYSQL_ASSOC))
                        {
                          echo '<tr>';
						  echo '<td>';
						 ?>
						 <input type="checkbox" class="checkbox"  name="chk[]"  value="<?php echo $row["question_id"]; ?>" style="opacity:1;"/>
						 <?php
						 echo '</td>';
						  echo '<td>'.$row["question"].'</td>';
						  echo '<td>'.$row["question_status"].'</td>';
						  echo '<td>'.$row["answer"].'</td>';
						  echo '<td>'.$row["email_id"].'</td>';
						   $id=$row["question_id"];
						  echo "<td><a href='questiondelete.php?id=$id'><input class='btn btn-danger' onclick='return del();' type='button' value='Delete' name='btndel'/></a> </td>";
						  echo "<td><a href='questionedit.php?id=$id'><input class='btn btn-success' onclick='return edit();' type='button' value='Edit' name='btndel'/></a> </td>";
                          echo '</tr>';
                        }
				?>
                </tbody>
