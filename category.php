      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			<form method="post" action="multiple_cat_delete.php">
				...
				<?php 
				 $con=mysql_connect("localhost","root","");
                        ...
                        while($row=mysql_fetch_array($res,MYSQL_ASSOC))
                        {
						  ...
						  echo '<td>';
					?>
					<input type="checkbox" class="checkbox"  name="chk[]"  value="<?php echo $row["category_id"]; ?>" style="opacity:1;"/>
					<?php 
					 echo '</td>';
						  echo '<td>'.$row["category_name"].'</td>';
						  echo '<td>'.$row["flag"].'</td>';
							$id=$row["category_id"];
						  echo "<td><a href='catdelete.php?id=$id'><input class='btn btn-danger' onclick='return del();' type='button' value='Delete' name='btndel'/></a> </td>";
						  echo "<td><a href='catedit.php?id=$id'><input class='btn btn-success' onclick='return edit();' type='button' value='Edit' name='btndel'/></a> </td>";
                          echo '</tr>';
                        }
				?>
                </tbody>
