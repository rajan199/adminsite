...
?>
  ...
  <!-- Content Wrapper. Contains page content -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="width: 1089px; background: white; margin-left: 231px; margin-top: 35px;">
                  <div class="x_title">
                    <h2 align="center"><b>Monthly Registered User Report</b></h2>
		...
		//	$m1=(int)$arr[1];
				...
				$res=mysql_query("select * from user_tbl where type='user' and  MONTH(join_date)='$m1'",$con);  
