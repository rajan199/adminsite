...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form method="post" action="mul_del_prescription.php">
      <div class="row">
        <div class="col-xs-12">
              ...
              <table id="example" class="table table-bordered table-striped">
				...
				<?php
						...
						echo '<td>'.$row["order_id"].'</td>';	
						  ...
						  echo '<img src="../images/'.$row["prescription_img"].'" style="height: 250px;
width: 360px;"></td>';
						  
						  echo "<td><a href='prescriptiondelete.php?id=$id'><input class='btn btn-danger' onclick='return del();' type='button' value='Delete' name='btndel'/></a> </td>";
