...
<div class="box box-primary">
			...
			$id=$_REQUEST["id"];
			 $con=mysql_connect("localhost","root","");
                        ...
                        $res=mysql_query("select * from company_tbl where company_id='$id'");
			...
			?>
            <form method="post" action="edit_company.php?id=<?php echo $id;?>" role="form">
			
              <div class="box-body">
			  <div class="form-group" hidden>
                  <label>Company ID</label>
                  <input type="text" disabled class="form-control" name="txt_comid" value="<?php echo $comid;?>">
                </div>
                <div class="form-group">
                  <label>Edit Company Name</label>
                  <input type="text" class="form-control" name="txt_comname" value="<?php echo $name;?>">
                </div>
				<div class="form-group">
                  <label>Edit Company Address</label>
                  <input type="text" class="form-control" name="txt_comadd" value="<?php echo $add;?>">
                </div>
				<div class="form-group">
                  <label>Edit Company Contact Number</label>
                  <input type="number" class="form-control" name="txt_comnumber" value="<?php echo $cno;?>">
                </div>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" name="insup">Update Company</button>
              </div>
