...
<div class="box box-primary">
			...
			$id=$_REQUEST["id"];
			 $con=mysql_connect("localhost","root","");
                        ...
                        $res=mysql_query("select * from category_tbl where category_id='$id'");
			...
			?>
            <form method="post" action="edit_category.php?id=<?php echo $id;?>" role="form">
			
              <div class="box-body">
			  <div class="form-group" hidden>
                  <label>Catagory ID</label>
                  <input type="text" disabled class="form-control" name="txt_catid" value="<?php echo $catid;?>">
                </div>
                <div class="form-group">
                  <label>Edit Catagory Name</label>
                  <input type="text" class="form-control" name="txt_catname" value="<?php echo $name;?>">
                </div>
				<div class="form-group">
                  <label>Select</label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" name="insup">Update Category</button>
              </div>
